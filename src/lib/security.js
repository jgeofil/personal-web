...
export function sanitizeUrl(url) {
	...
	// URL decode and HTML decode iteratively to handle nested encodings
	// like javascript&#37;3aalert(1) (HTML-encoding a URL-encoded character)
	let decodedUrl = url;
	let prevUrl;
	do {
		prevUrl = decodedUrl;
		try {
			...
			// Ignore invalid URL encoding, continue to HTML decoding
		}
